...
function matlabbatch = coregister_job(reference, main_image, images_to_co_coregister, prefix)
...
matlabbatch{1}.spm.spatial.coreg.estwrite.roptions.prefix = out_prefix;
